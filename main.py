...
back_img = pygame.image.load("img_2.png")
floor_img = pygame.image.load("img_6.png")
floor_x = 0

bird_up = pygame.image.load("img_3.png")
bird_down = pygame.image.load("img_4.png")
bird_mid = pygame.image.load("img_5.png")
...
game_over = False
over_img = pygame.image.load("img_1.png").convert_alpha()
    ...
    for event in pygame.event.get():
        ...
        if event.type == pygame.KEYDOWN:
            if event.key == pygame.K_SPACE and not game_over:
                bird_movement = 0
                bird_movement = bird_movement_up
